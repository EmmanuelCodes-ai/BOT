...
export class BBMeanReversionStrategy implements Strategy {
  ...
  evaluate(ctx: StrategyContext): StrategyResult {
    ...
    const { bollinger, rsi14, atr14, close } = indicators;
    ...
    // ── 4. Current candle closed back INSIDE the band ─────
    ...
    // ── 5. Bandwidth filter — avoid ultra-narrow bands (flat noise) ──
